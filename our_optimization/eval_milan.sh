#!/bin/bash
# JBD2 Fast Commit Barrier Deferral — Evaluation Script for MILAN
#
# INSTRUCTIONS FOR MILAN:
# ─────────────────────────────────────────────────────────────────
#
...
#     sudo bash eval_milan.sh
#     → saves to: our_optimization/eval_results/milan/STOCK_<kernel>/
#
...
#     sudo bash eval_milan.sh
#     → saves to: our_optimization/eval_results/milan/PATCHED_<kernel>/
#
#   STEP 5 — Commit and push results:
#     git add our_optimization/eval_results/milan/
#     git commit -m "results: milan bare-metal evaluation"
#     git push
...
echo ""
echo "Push results:"
echo "  git add our_optimization/eval_results/milan/"
echo "  git commit -m 'results: milan bare-metal ${RUN_LABEL}'"
echo "  git push"
