...
- **Bare-metal validation pending.** VM result is convincing (identical
  structural pattern to C3 which Milan confirmed). Bare-metal rerun on
  Milan's EPYC would close the loop.
