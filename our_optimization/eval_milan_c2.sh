#!/bin/bash
# JBD2 ASYNC BITMAP PREFETCH — Evaluation Script for MILAN (Candidate 2)
#
...
#
# Run TWICE:
#   Step 1 (STOCK):    sudo bash eval_milan_c2.sh    # on an unpatched 6.1.4 kernel
#   Step 2 (PATCHED):  sudo bash eval_milan_c2.sh    # on the cs614-c2-patched kernel
#
